...
AForm::AForm(const std::string &name, int eg, int sg) : _name(name), _s_grade(sg), _e_grade(eg)
{
...
AForm::AForm(const AForm &origine) : _name(origine._name) , _s_grade(origine._s_grade), _e_grade(origine._e_grade) {
